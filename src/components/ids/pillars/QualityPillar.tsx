...
export function QualityPillar() {
  // Fetch real data quality metrics from parcels
  ...
  // Fetch latest quality_scored pipeline events for real scoring data
  ...
  // Fetch recent ingest jobs with validation results
