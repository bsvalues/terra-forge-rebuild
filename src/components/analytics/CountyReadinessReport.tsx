// TerraFusion OS — County Readiness Report (Phase 195)
...
function buildMarkdown(
  ...
  return [
    ...
    "",
    `> Generated: ${today} | TerraFusion OS v1.0 | Phase 195`,
    "",
    "---",
    "",
    "## County Profile",
    ...
    "---",
    "",
    `*Report generated by TerraFusion OS — County Onboarding Module (Phase 195)*`,
...
export function CountyReadinessReport() {
  ...
  const handleDownload = () => {
    if (!meta || !diff) return;
    const content = buildMarkdown(selectedSlug, meta, diff, diff.parcel_count);
              ...
              <Card className="bg-white/3 border-white/8">
                ...
                <CardContent className="pt-0 space-y-2 text-xs">
                  {[
                    ...
                    { label: "Parcels", value: diff.parcel_count != null ? diff.parcel_count.toLocaleString() : "N/A" },
